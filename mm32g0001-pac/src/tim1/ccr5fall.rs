...
#[doc = "Field `CCR5FALL` reader - compare value for ch5 when counting down in PWM center-aligned mode"]
pub type Ccr5fallR = crate::FieldReader<u16>;
#[doc = "Field `CCR5FALL` writer - compare value for ch5 when counting down in PWM center-aligned mode"]
pub type Ccr5fallW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15 - compare value for ch5 when counting down in PWM center-aligned mode"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:15 - compare value for ch5 when counting down in PWM center-aligned mode"]
    #[inline(always)]
    pub fn ccr5fall(&mut self) -> Ccr5fallW<Ccr5fallSpec> {
