...
#[doc = "Field `CCR4FALL` reader - compare value for ch4 when counting down in PWM center-aligned mode"]
pub type Ccr4fallR = crate::FieldReader<u16>;
#[doc = "Field `CCR4FALL` writer - compare value for ch4 when counting down in PWM center-aligned mode"]
pub type Ccr4fallW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15 - compare value for ch4 when counting down in PWM center-aligned mode"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:15 - compare value for ch4 when counting down in PWM center-aligned mode"]
    #[inline(always)]
    pub fn ccr4fall(&mut self) -> Ccr4fallW<Ccr4fallSpec> {
