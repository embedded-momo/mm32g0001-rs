...
#[doc = "Field `CCR3FALL` reader - compare value for ch3 when counting down in PWM center-aligned mode"]
pub type Ccr3fallR = crate::FieldReader<u16>;
#[doc = "Field `CCR3FALL` writer - compare value for ch3 when counting down in PWM center-aligned mode"]
pub type Ccr3fallW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15 - compare value for ch3 when counting down in PWM center-aligned mode"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:15 - compare value for ch3 when counting down in PWM center-aligned mode"]
    #[inline(always)]
    pub fn ccr3fall(&mut self) -> Ccr3fallW<Ccr3fallSpec> {
