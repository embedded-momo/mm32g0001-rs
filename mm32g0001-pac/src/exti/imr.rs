...
pub type Imr17R = crate::BitReader;
#[doc = "Field `IMR17` writer - Interrupt Mask on line 17"]
pub type Imr17W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn imr17(&self) -> Imr17R {
        Imr17R::new(((self.bits >> 17) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Interrupt Mask on line 0"]
    #[inline(always)]
    pub fn imr0(&mut self) -> Imr0W<ImrSpec> {
        Imr0W::new(self, 0)
    }
    #[doc = "Bit 1 - Interrupt Mask on line 1"]
    #[inline(always)]
    pub fn imr1(&mut self) -> Imr1W<ImrSpec> {
        Imr1W::new(self, 1)
    }
    #[doc = "Bit 2 - Interrupt Mask on line 2"]
    #[inline(always)]
    pub fn imr2(&mut self) -> Imr2W<ImrSpec> {
        Imr2W::new(self, 2)
    }
    #[doc = "Bit 3 - Interrupt Mask on line 3"]
    #[inline(always)]
    pub fn imr3(&mut self) -> Imr3W<ImrSpec> {
        Imr3W::new(self, 3)
    }
    #[doc = "Bit 4 - Interrupt Mask on line 4"]
    #[inline(always)]
    pub fn imr4(&mut self) -> Imr4W<ImrSpec> {
        Imr4W::new(self, 4)
    }
    #[doc = "Bit 5 - Interrupt Mask on line 5"]
    #[inline(always)]
    pub fn imr5(&mut self) -> Imr5W<ImrSpec> {
        Imr5W::new(self, 5)
    }
    #[doc = "Bit 6 - Interrupt Mask on line 6"]
    #[inline(always)]
    pub fn imr6(&mut self) -> Imr6W<ImrSpec> {
        Imr6W::new(self, 6)
    }
    #[doc = "Bit 7 - Interrupt Mask on line 7"]
    #[inline(always)]
    pub fn imr7(&mut self) -> Imr7W<ImrSpec> {
        Imr7W::new(self, 7)
    }
    #[doc = "Bit 8 - Interrupt Mask on line 8"]
    #[inline(always)]
    pub fn imr8(&mut self) -> Imr8W<ImrSpec> {
        Imr8W::new(self, 8)
    }
    #[doc = "Bit 9 - Interrupt Mask on line 9"]
    #[inline(always)]
    pub fn imr9(&mut self) -> Imr9W<ImrSpec> {
        Imr9W::new(self, 9)
    }
    #[doc = "Bit 10 - Interrupt Mask on line 10"]
    #[inline(always)]
    pub fn imr10(&mut self) -> Imr10W<ImrSpec> {
        Imr10W::new(self, 10)
    }
    #[doc = "Bit 11 - Interrupt Mask on line 11"]
    #[inline(always)]
    pub fn imr11(&mut self) -> Imr11W<ImrSpec> {
        Imr11W::new(self, 11)
    }
    #[doc = "Bit 12 - Interrupt Mask on line 12"]
    #[inline(always)]
    pub fn imr12(&mut self) -> Imr12W<ImrSpec> {
        Imr12W::new(self, 12)
    }
    #[doc = "Bit 13 - Interrupt Mask on line 13"]
    #[inline(always)]
    pub fn imr13(&mut self) -> Imr13W<ImrSpec> {
        Imr13W::new(self, 13)
    }
    #[doc = "Bit 14 - Interrupt Mask on line 14"]
    #[inline(always)]
    pub fn imr14(&mut self) -> Imr14W<ImrSpec> {
        Imr14W::new(self, 14)
    }
    #[doc = "Bit 15 - Interrupt Mask on line 15"]
    #[inline(always)]
    pub fn imr15(&mut self) -> Imr15W<ImrSpec> {
        Imr15W::new(self, 15)
    }
    #[doc = "Bit 16 - Interrupt Mask on line 16"]
    #[inline(always)]
    pub fn imr16(&mut self) -> Imr16W<ImrSpec> {
        Imr16W::new(self, 16)
    }
    #[doc = "Bit 17 - Interrupt Mask on line 17"]
    #[inline(always)]
    pub fn imr17(&mut self) -> Imr17W<ImrSpec> {
        Imr17W::new(self, 17)
    }
}
