...
impl W {
    #[doc = "Bit 0 - This bit controls whether the DW_apb_i2c master is enabled"]
    #[inline(always)]
    pub fn master(&mut self) -> MasterW<CrSpec> {
        MasterW::new(self, 0)
    }
    #[doc = "Bits 1:2 - These bits control at which speed the DW_apb_i2c operates"]
    #[inline(always)]
    pub fn speed(&mut self) -> SpeedW<CrSpec> {
        SpeedW::new(self, 1)
    }
    #[doc = "Bit 3 - When acting as a alsve"]
    #[inline(always)]
    pub fn slave10(&mut self) -> Slave10W<CrSpec> {
        Slave10W::new(self, 3)
    }
    #[doc = "Bit 4 - Address mode when acting as a master"]
    #[inline(always)]
    pub fn master10(&mut self) -> Master10W<CrSpec> {
        Master10W::new(self, 4)
    }
    #[doc = "Bit 5 - Determines whether RESTART comdtions may be sent when acting as a master"]
    #[inline(always)]
    pub fn repen(&mut self) -> RepenW<CrSpec> {
        RepenW::new(self, 5)
    }
    #[doc = "Bit 6 - This bit controls whether I2C has its slave diabled"]
    #[inline(always)]
    pub fn disslave(&mut self) -> DisslaveW<CrSpec> {
        DisslaveW::new(self, 6)
    }
    #[doc = "Bit 7 - STOP_DET_IFADDRESSED"]
    #[inline(always)]
    pub fn stopint(&mut self) -> StopintW<CrSpec> {
        StopintW::new(self, 7)
    }
    #[doc = "Bit 8 - This bit controls the generation of the TX_EMPTY interrupt"]
    #[inline(always)]
    pub fn empint(&mut self) -> EmpintW<CrSpec> {
        EmpintW::new(self, 8)
    }
}
