...
impl RegisterBlock {
    ...
    #[doc = "0x54 - compare mode register 3 (output mode)"]
    #[inline(always)]
    pub const fn ccmr3_output(&self) -> &Ccmr3Output {
        &self.ccmr3_output
    }
    #[doc = "0x58 - compare register 5"]
    #[inline(always)]
