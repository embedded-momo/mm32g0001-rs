...
impl W {
    #[doc = "Bit 0 - Transmitter FIFO empty interrupt clear bit"]
    #[inline(always)]
    pub fn tx_iclr(&mut self) -> TxIclrW<IntclrSpec> {
        TxIclrW::new(self, 0)
    }
    #[doc = "Bit 1 - Receive interrupt clear bit"]
    #[inline(always)]
    pub fn rx_iclr(&mut self) -> RxIclrW<IntclrSpec> {
        RxIclrW::new(self, 1)
    }
    #[doc = "Bit 2 - Transmitter underrun interrupt clear bit(SPI slave mode only)"]
    #[inline(always)]
    pub fn underrun_iclr(&mut self) -> UnderrunIclrW<IntclrSpec> {
        UnderrunIclrW::new(self, 2)
    }
    #[doc = "Bit 3 - Overrun error interrupt clear bit"]
    #[inline(always)]
    pub fn rxoerr_iclr(&mut self) -> RxoerrIclrW<IntclrSpec> {
        RxoerrIclrW::new(self, 3)
    }
    #[doc = "Bit 4 - Receive completed interrupt clear bit"]
    #[inline(always)]
    pub fn rxmatch_iclr(&mut self) -> RxmatchIclrW<IntclrSpec> {
        RxmatchIclrW::new(self, 4)
    }
    #[doc = "Bit 5 - Receiver buffer full interrupt clear bit"]
    #[inline(always)]
    pub fn rxfull_iclr(&mut self) -> RxfullIclrW<IntclrSpec> {
        RxfullIclrW::new(self, 5)
    }
    #[doc = "Bit 6 - Transmitter empty interrupt clear bit"]
    #[inline(always)]
    pub fn txept_iclr(&mut self) -> TxeptIclrW<IntclrSpec> {
