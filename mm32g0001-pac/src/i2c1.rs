...
impl RegisterBlock {
    ...
    #[doc = "0xb0 - Slave mask Register"]
    #[inline(always)]
    pub const fn slvmask(&self) -> &Slvmask {
        &self.slvmask
    }
    #[doc = "0xb4 - Slave received address Register"]
    #[inline(always)]
