...
impl W {
    #[doc = "Bits 0:3 - Multiplexing function selection for bit 0 of portx"]
    #[inline(always)]
    pub fn afr0(&mut self) -> Afr0W<AfrlSpec> {
        Afr0W::new(self, 0)
    }
    #[doc = "Bits 4:7 - Multiplexing function selection for bit 1 of portx"]
    #[inline(always)]
    pub fn afr1(&mut self) -> Afr1W<AfrlSpec> {
        Afr1W::new(self, 4)
    }
    #[doc = "Bits 8:11 - Multiplexing function selection for bit 2 of portx"]
    #[inline(always)]
    pub fn afr2(&mut self) -> Afr2W<AfrlSpec> {
        Afr2W::new(self, 8)
    }
    #[doc = "Bits 12:15 - Multiplexing function selection for bit 3 of portx"]
    #[inline(always)]
    pub fn afr3(&mut self) -> Afr3W<AfrlSpec> {
        Afr3W::new(self, 12)
    }
    #[doc = "Bits 16:19 - Multiplexing function selection for bit 4 of portx"]
    #[inline(always)]
    pub fn afr4(&mut self) -> Afr4W<AfrlSpec> {
        Afr4W::new(self, 16)
    }
    #[doc = "Bits 20:23 - Multiplexing function selection for bit 5 of portx"]
    #[inline(always)]
    pub fn afr5(&mut self) -> Afr5W<AfrlSpec> {
        Afr5W::new(self, 20)
    }
    #[doc = "Bits 24:27 - Multiplexing function selection for bit 6 of portx"]
    #[inline(always)]
    pub fn afr6(&mut self) -> Afr6W<AfrlSpec> {
        Afr6W::new(self, 24)
    }
    #[doc = "Bits 28:31 - Multiplexing function selection for bit 7 of portx"]
    #[inline(always)]
    pub fn afr7(&mut self) -> Afr7W<AfrlSpec> {
        Afr7W::new(self, 28)
    }
}
