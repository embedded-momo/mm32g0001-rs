...
impl W {
    #[doc = "Bits 0:3 - Multiplexing function selection for bit 8 of portx"]
    #[inline(always)]
    pub fn afr8(&mut self) -> Afr8W<AfrhSpec> {
        Afr8W::new(self, 0)
    }
    #[doc = "Bits 4:7 - Multiplexing function selection for bit 9 of portx"]
    #[inline(always)]
    pub fn afr9(&mut self) -> Afr9W<AfrhSpec> {
        Afr9W::new(self, 4)
    }
    #[doc = "Bits 8:11 - Multiplexing function selection for bit 10 of portx"]
    #[inline(always)]
    pub fn afr10(&mut self) -> Afr10W<AfrhSpec> {
        Afr10W::new(self, 8)
    }
    #[doc = "Bits 12:15 - Multiplexing function selection for bit 11 of portx"]
    #[inline(always)]
    pub fn afr11(&mut self) -> Afr11W<AfrhSpec> {
        Afr11W::new(self, 12)
    }
    #[doc = "Bits 16:19 - Multiplexing function selection for bit 12 of portx"]
    #[inline(always)]
    pub fn afr12(&mut self) -> Afr12W<AfrhSpec> {
        Afr12W::new(self, 16)
    }
    #[doc = "Bits 20:23 - Multiplexing function selection for bit 13 of portx"]
    #[inline(always)]
    pub fn afr13(&mut self) -> Afr13W<AfrhSpec> {
        Afr13W::new(self, 20)
    }
    #[doc = "Bits 24:27 - Multiplexing function selection for bit 14 of portx"]
    #[inline(always)]
    pub fn afr14(&mut self) -> Afr14W<AfrhSpec> {
        Afr14W::new(self, 24)
    }
    #[doc = "Bits 28:31 - Multiplexing function selection for bit 15 of portx"]
    #[inline(always)]
    pub fn afr15(&mut self) -> Afr15W<AfrhSpec> {
        Afr15W::new(self, 28)
    }
}
