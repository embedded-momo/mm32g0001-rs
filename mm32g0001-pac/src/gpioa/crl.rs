...
impl W {
    ...
    #[doc = "Bits 8:9 - Port 2 mode bits"]
    #[inline(always)]
    pub fn mode2(&mut self) -> Mode2W<CrlSpec> {
        Mode2W::new(self, 8)
    }
    #[doc = "Bits 10:11 - Port 2 configuration bits"]
    #[inline(always)]
    pub fn cnf2(&mut self) -> Cnf2W<CrlSpec> {
        Cnf2W::new(self, 10)
    }
    #[doc = "Bits 12:13 - Port 3 mode bits"]
    #[inline(always)]
    pub fn mode3(&mut self) -> Mode3W<CrlSpec> {
        Mode3W::new(self, 12)
    }
    #[doc = "Bits 14:15 - Port 3 configuration bits"]
    #[inline(always)]
    pub fn cnf3(&mut self) -> Cnf3W<CrlSpec> {
        Cnf3W::new(self, 14)
    }
    #[doc = "Bits 16:17 - Port 4 mode bits"]
    #[inline(always)]
    pub fn mode4(&mut self) -> Mode4W<CrlSpec> {
        Mode4W::new(self, 16)
    }
    #[doc = "Bits 18:19 - Port 4 configuration bits"]
    #[inline(always)]
    pub fn cnf4(&mut self) -> Cnf4W<CrlSpec> {
        Cnf4W::new(self, 18)
    }
    #[doc = "Bits 20:21 - Port 5 mode bits"]
    #[inline(always)]
    pub fn mode5(&mut self) -> Mode5W<CrlSpec> {
        Mode5W::new(self, 20)
    }
    #[doc = "Bits 22:23 - Port 5 configuration bits"]
    #[inline(always)]
    pub fn cnf5(&mut self) -> Cnf5W<CrlSpec> {
        Cnf5W::new(self, 22)
    }
    #[doc = "Bits 24:25 - Port 6 mode bits"]
    #[inline(always)]
    pub fn mode6(&mut self) -> Mode6W<CrlSpec> {
        Mode6W::new(self, 24)
    }
    #[doc = "Bits 26:27 - Port 6 configuration bits"]
    #[inline(always)]
    pub fn cnf6(&mut self) -> Cnf6W<CrlSpec> {
        Cnf6W::new(self, 26)
    }
    #[doc = "Bits 28:29 - Port 7 mode bits"]
    #[inline(always)]
    pub fn mode7(&mut self) -> Mode7W<CrlSpec> {
        Mode7W::new(self, 28)
    }
    #[doc = "Bits 30:31 - Port 7 configuration bits"]
    #[inline(always)]
    pub fn cnf7(&mut self) -> Cnf7W<CrlSpec> {
        Cnf7W::new(self, 30)
    }
}
