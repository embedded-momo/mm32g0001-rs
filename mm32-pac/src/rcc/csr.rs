...
impl W {
    ...
    #[doc = "Bit 6 - PVD reset enable"]
    #[inline(always)]
    pub fn pvdrsten(&mut self) -> PvdrstenW<CsrSpec> {
        PvdrstenW::new(self, 6)
    }
    #[doc = "Bit 7 - CPU lockup reset enable"]
    #[inline(always)]
    pub fn lockupen(&mut self) -> LockupenW<CsrSpec> {
        LockupenW::new(self, 7)
    }
    #[doc = "Bit 22 - PVD reset flag"]
    #[inline(always)]
    pub fn pvdrstf(&mut self) -> PvdrstfW<CsrSpec> {
        PvdrstfW::new(self, 22)
    }
    #[doc = "Bit 23 - CPU lockup reset flag"]
    #[inline(always)]
    pub fn lockupf(&mut self) -> LockupfW<CsrSpec> {
...
#[doc = "`reset()` method sets CSR to value 0x0800_0000"]
