...
#[doc = "Field `CC1S` reader - compare 1 selection"]
pub type Cc1sR = crate::FieldReader;
#[doc = "Field `CC1S` writer - compare 1 selection"]
...
#[doc = "Field `CC2S` reader - Compare 2 selection"]
pub type Cc2sR = crate::FieldReader;
#[doc = "Field `CC2S` writer - Compare 2 selection"]
...
impl R {
    #[doc = "Bits 0:1 - compare 1 selection"]
    #[inline(always)]
    ...
    #[doc = "Bits 8:9 - Compare 2 selection"]
    #[inline(always)]
