...
impl W {
    #[doc = "Bits 0:1 - Port 8 mode bits"]
    #[inline(always)]
    pub fn mode8(&mut self) -> Mode8W<CrhSpec> {
        Mode8W::new(self, 0)
    }
    #[doc = "Bits 2:3 - Port 8 configuration bits"]
    #[inline(always)]
    pub fn cnf8(&mut self) -> Cnf8W<CrhSpec> {
        Cnf8W::new(self, 2)
    }
    #[doc = "Bits 4:5 - Port 9 mode bits"]
    #[inline(always)]
    pub fn mode9(&mut self) -> Mode9W<CrhSpec> {
        Mode9W::new(self, 4)
    }
    #[doc = "Bits 6:7 - Port 9 configuration bits"]
    #[inline(always)]
    pub fn cnf9(&mut self) -> Cnf9W<CrhSpec> {
        Cnf9W::new(self, 6)
    }
    #[doc = "Bits 8:9 - Port 10 mode bits"]
    #[inline(always)]
    pub fn mode10(&mut self) -> Mode10W<CrhSpec> {
        Mode10W::new(self, 8)
    }
    #[doc = "Bits 10:11 - Port 10 configuration bits"]
    #[inline(always)]
    pub fn cnf10(&mut self) -> Cnf10W<CrhSpec> {
        Cnf10W::new(self, 10)
    }
    #[doc = "Bits 12:13 - Port 11 mode bits"]
    #[inline(always)]
    pub fn mode11(&mut self) -> Mode11W<CrhSpec> {
        Mode11W::new(self, 12)
    }
    #[doc = "Bits 14:15 - Port 11 configuration bits"]
    #[inline(always)]
    pub fn cnf11(&mut self) -> Cnf11W<CrhSpec> {
        Cnf11W::new(self, 14)
    }
    #[doc = "Bits 16:17 - Port 12 mode bits"]
    #[inline(always)]
    pub fn mode12(&mut self) -> Mode12W<CrhSpec> {
        Mode12W::new(self, 16)
    }
    #[doc = "Bits 18:19 - Port 12 configuration bits"]
    #[inline(always)]
    pub fn cnf12(&mut self) -> Cnf12W<CrhSpec> {
        Cnf12W::new(self, 18)
    }
    #[doc = "Bits 20:21 - Port 13 mode bits"]
    #[inline(always)]
    pub fn mode13(&mut self) -> Mode13W<CrhSpec> {
        Mode13W::new(self, 20)
    }
    #[doc = "Bits 22:23 - Port 13 configuration bits"]
    #[inline(always)]
    pub fn cnf13(&mut self) -> Cnf13W<CrhSpec> {
        Cnf13W::new(self, 22)
    }
    #[doc = "Bits 24:25 - Port 14 mode bits"]
    #[inline(always)]
    pub fn mode14(&mut self) -> Mode14W<CrhSpec> {
        Mode14W::new(self, 24)
    }
    #[doc = "Bits 26:27 - Port 14 configuration bits"]
    #[inline(always)]
    pub fn cnf14(&mut self) -> Cnf14W<CrhSpec> {
        Cnf14W::new(self, 26)
    }
    #[doc = "Bits 28:29 - Port 15 mode bits"]
    #[inline(always)]
    pub fn mode15(&mut self) -> Mode15W<CrhSpec> {
        Mode15W::new(self, 28)
    }
    #[doc = "Bits 30:31 - Port 15 configuration bits"]
    #[inline(always)]
    pub fn cnf15(&mut self) -> Cnf15W<CrhSpec> {
        Cnf15W::new(self, 30)
    }
}
