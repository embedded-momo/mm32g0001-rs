...
impl W {
    ...
    #[doc = "Bits 4:5 - PX2"]
    #[inline(always)]
    pub fn px2(&mut self) -> Px2W<DcrSpec> {
        Px2W::new(self, 4)
    }
    #[doc = "Bits 6:7 - PX3"]
    #[inline(always)]
    pub fn px3(&mut self) -> Px3W<DcrSpec> {
        Px3W::new(self, 6)
    }
    #[doc = "Bits 8:9 - PX4"]
    #[inline(always)]
    pub fn px4(&mut self) -> Px4W<DcrSpec> {
        Px4W::new(self, 8)
    }
    #[doc = "Bits 10:11 - PX5"]
    #[inline(always)]
    pub fn px5(&mut self) -> Px5W<DcrSpec> {
        Px5W::new(self, 10)
    }
    #[doc = "Bits 12:13 - PX6"]
    #[inline(always)]
    pub fn px6(&mut self) -> Px6W<DcrSpec> {
        Px6W::new(self, 12)
    }
    #[doc = "Bits 14:15 - PX7"]
    #[inline(always)]
    pub fn px7(&mut self) -> Px7W<DcrSpec> {
        Px7W::new(self, 14)
    }
    #[doc = "Bits 16:17 - PX8"]
    #[inline(always)]
    pub fn px8(&mut self) -> Px8W<DcrSpec> {
        Px8W::new(self, 16)
    }
    #[doc = "Bits 18:19 - PX9"]
    #[inline(always)]
    pub fn px9(&mut self) -> Px9W<DcrSpec> {
        Px9W::new(self, 18)
    }
    #[doc = "Bits 20:21 - PX10"]
    #[inline(always)]
    pub fn px10(&mut self) -> Px10W<DcrSpec> {
        Px10W::new(self, 20)
    }
    #[doc = "Bits 22:23 - PX11"]
    #[inline(always)]
    pub fn px11(&mut self) -> Px11W<DcrSpec> {
        Px11W::new(self, 22)
    }
    #[doc = "Bits 24:25 - PX12"]
    #[inline(always)]
    pub fn px12(&mut self) -> Px12W<DcrSpec> {
        Px12W::new(self, 24)
    }
    #[doc = "Bits 26:27 - PX13"]
    #[inline(always)]
    pub fn px13(&mut self) -> Px13W<DcrSpec> {
        Px13W::new(self, 26)
    }
    #[doc = "Bits 28:29 - PX14"]
    #[inline(always)]
    pub fn px14(&mut self) -> Px14W<DcrSpec> {
        Px14W::new(self, 28)
    }
    #[doc = "Bits 30:31 - PX15"]
    #[inline(always)]
    pub fn px15(&mut self) -> Px15W<DcrSpec> {
        Px15W::new(self, 30)
    }
}
