...
impl W {
    #[doc = "Bit 1 - CCR1 pwm shift enable"]
    #[inline(always)]
    pub fn ccr1shiften(&mut self) -> Ccr1shiftenW<PderSpec> {
        Ccr1shiftenW::new(self, 1)
    }
    #[doc = "Bit 2 - CCR2 pwm shift enable"]
    #[inline(always)]
    pub fn ccr2shiften(&mut self) -> Ccr2shiftenW<PderSpec> {
        Ccr2shiftenW::new(self, 2)
    }
    #[doc = "Bit 3 - CCR3 pwm shift enable"]
    #[inline(always)]
    pub fn ccr3shiften(&mut self) -> Ccr3shiftenW<PderSpec> {
        Ccr3shiftenW::new(self, 3)
    }
    #[doc = "Bit 4 - CCR4 pwm shift enable"]
    #[inline(always)]
    pub fn ccr4shiften(&mut self) -> Ccr4shiftenW<PderSpec> {
        Ccr4shiftenW::new(self, 4)
    }
    #[doc = "Bit 5 - CCR5 pwm shift enable"]
    #[inline(always)]
    pub fn ccr5shiften(&mut self) -> Ccr5shiftenW<PderSpec> {
