...
#[doc = "Field `CCR1FALL` reader - compare value for ch1 when counting down in PWM center-aligned mode"]
pub type Ccr1fallR = crate::FieldReader<u16>;
#[doc = "Field `CCR1FALL` writer - compare value for ch1 when counting down in PWM center-aligned mode"]
pub type Ccr1fallW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15 - compare value for ch1 when counting down in PWM center-aligned mode"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:15 - compare value for ch1 when counting down in PWM center-aligned mode"]
    #[inline(always)]
    pub fn ccr1fall(&mut self) -> Ccr1fallW<Ccr1fallSpec> {
