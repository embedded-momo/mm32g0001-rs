...
#[doc = "Field `CCR2FALL` reader - compare value for ch2 when counting down in PWM center-aligned mode"]
pub type Ccr2fallR = crate::FieldReader<u16>;
#[doc = "Field `CCR2FALL` writer - compare value for ch2 when counting down in PWM center-aligned mode"]
pub type Ccr2fallW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15 - compare value for ch2 when counting down in PWM center-aligned mode"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:15 - compare value for ch2 when counting down in PWM center-aligned mode"]
    #[inline(always)]
    pub fn ccr2fall(&mut self) -> Ccr2fallW<Ccr2fallSpec> {
