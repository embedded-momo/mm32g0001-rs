...
impl W {
    #[doc = "Bit 0 - Clock phase select bit"]
    #[inline(always)]
    pub fn cpha(&mut self) -> CphaW<CctlSpec> {
        CphaW::new(self, 0)
    }
    #[doc = "Bit 1 - Clock polarity select bit"]
    #[inline(always)]
    pub fn cpol(&mut self) -> CpolW<CctlSpec> {
        CpolW::new(self, 1)
    }
    #[doc = "Bit 2 - LSI first enable bit"]
    #[inline(always)]
    pub fn lsbfe(&mut self) -> LsbfeW<CctlSpec> {
        LsbfeW::new(self, 2)
    }
    #[doc = "Bit 3 - SPI character length bit"]
    #[inline(always)]
    pub fn spilen(&mut self) -> SpilenW<CctlSpec> {
        SpilenW::new(self, 3)
    }
    #[doc = "Bit 4 - Receive data edge select"]
    #[inline(always)]
    pub fn rxedge(&mut self) -> RxedgeW<CctlSpec> {
        RxedgeW::new(self, 4)
    }
    #[doc = "Bit 5 - Transmit data edge select"]
    #[inline(always)]
    pub fn txedge(&mut self) -> TxedgeW<CctlSpec> {
        TxedgeW::new(self, 5)
    }
    #[doc = "Bit 6 - CPHA polarity select"]
    #[inline(always)]
    pub fn cphasel(&mut self) -> CphaselW<CctlSpec> {
        CphaselW::new(self, 6)
    }
    #[doc = "Bit 7 - High speed slave mode"]
    #[inline(always)]
    pub fn hispd(&mut self) -> HispdW<CctlSpec> {
        HispdW::new(self, 7)
    }
}
