...
impl W {
    #[doc = "Bit 0 - SPI select bit"]
    #[inline(always)]
    pub fn spien(&mut self) -> SpienW<GctlSpec> {
        SpienW::new(self, 0)
    }
    #[doc = "Bit 1 - SPI interrupt enable bit"]
    #[inline(always)]
    pub fn int_en(&mut self) -> IntEnW<GctlSpec> {
        IntEnW::new(self, 1)
    }
    #[doc = "Bit 2 - Master mode bit"]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<GctlSpec> {
        ModeW::new(self, 2)
    }
    #[doc = "Bit 3 - Transmit enable bit"]
    #[inline(always)]
    pub fn txen(&mut self) -> TxenW<GctlSpec> {
        TxenW::new(self, 3)
    }
    #[doc = "Bit 4 - Receive enable bit"]
    #[inline(always)]
    pub fn rxen(&mut self) -> RxenW<GctlSpec> {
        RxenW::new(self, 4)
    }
    #[doc = "Bits 5:6 - RX FIFO trigger level bit"]
    #[inline(always)]
    pub fn rxtlf(&mut self) -> RxtlfW<GctlSpec> {
        RxtlfW::new(self, 5)
    }
    #[doc = "Bits 7:8 - TX FIFO trigger level bit"]
    #[inline(always)]
    pub fn txtlf(&mut self) -> TxtlfW<GctlSpec> {
        TxtlfW::new(self, 7)
    }
    #[doc = "Bit 9 - DMA access mode enable"]
    #[inline(always)]
    pub fn dmaen(&mut self) -> DmaenW<GctlSpec> {
        DmaenW::new(self, 9)
    }
    #[doc = "Bit 10 - NSS select signal that from software and hardware"]
    #[inline(always)]
    pub fn nss_sel(&mut self) -> NssSelW<GctlSpec> {
        NssSelW::new(self, 10)
    }
    #[doc = "Bit 11 - Valid byte or double-word data select signal"]
    #[inline(always)]
    pub fn dw8_32(&mut self) -> Dw8_32W<GctlSpec> {
        Dw8_32W::new(self, 11)
    }
    #[doc = "Bit 12 - NSS selection signal is automatically flipped"]
    #[inline(always)]
    pub fn nsstog(&mut self) -> NsstogW<GctlSpec> {
        NsstogW::new(self, 12)
    }
}
